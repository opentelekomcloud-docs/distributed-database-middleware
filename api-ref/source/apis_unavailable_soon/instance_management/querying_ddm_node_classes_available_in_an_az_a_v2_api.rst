...
Querying DDM Node Classes Available in an AZ (a V2 API)
=======================================================
...
-  Use the latest API. For details, see :ref:`Querying DDM Node Classes Available in Each AZ (a V3 API) <ddm_api_01_0110>`.
...
.. code-block:: text
   ...
   GET https://ddm.eu-de.otc.t-systems.com/v2/619d3e78f61b4be68bc5aa0b59edcf7b/flavors?engine_id=b6907aa2-aacb-3ac9-9782-b90b152d456c
