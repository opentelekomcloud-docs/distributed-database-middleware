...
Querying Details of a DDM Instance Node (a V1 API)
==================================================
...
-  Use the latest API. For details, see :ref:`Querying Details About a DDM Instance Node (a V3 API) <en-us_topic_0000002181783550>`.
...
.. table:: **Table 3** Response body parameters
   ...
   +-----------------+--------+---------------------------------------------------------------------------+
   | group_id        | String | ID of the group that the node belongs to                                  |
   +-----------------+--------+---------------------------------------------------------------------------+
...
.. code-block:: text
   ...
   GET https://ddm.eu-de.otc.t-systems.com/v1/619d3e78f61b4be68bc5aa0b59edcf7b/instances/1f5c9fd6cd984056ba89c8c87cc03278in09/nodes/4a2b97b7f5e3462c9c78aae93b46ed83no09
