...
Creating a DDM instance (a V1 API)
==================================
...
-  Use the latest API. For details, see :ref:`Creating a DDM Instance (a V3 API) <en-us_topic_0000002332909529>`.
...
.. table:: **Table 4** CreateInstanceDetail
   ...
   +---------------------+-----------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | param_group_id      | No              | String           | Parameter group ID. It can be obtained from :ref:`Obtaining Parameter Templates (a V3 API) <ddm_api_01_0105_0>`.                                                                                                                                                                                                                                                                                                                                   |
   +---------------------+-----------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. code-block:: text
   ...
   POST https://ddm.eu-de.otc.t-systems.com/v1/619d3e78f61b4be68bc5aa0b59edcf7b/instances
