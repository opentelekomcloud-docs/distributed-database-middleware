:original_name: ddm_api_01_0022.html

.. _ddm_api_01_0022:

Deleting a DDM Instance (a V1 API)
==================================
...
-  Use the latest API. For details, see :ref:`Deleting an Instance (a V3 API) <ddm_api_01_0113>`.
...
-  Request to delete a DDM instance (including the data stored on the associated DB instances)
   ...
   .. code-block:: text
      ...
      DELETE https://ddm.eu-de.otc.t-systems.com/v1/619d3e78f61b4be68bc5aa0b59edcf7b/instances/1f5c9fd6cd984056ba89c8c87cc03278in09?delete_rds_data=true

-  Request to delete a DDM instance (excluding the data stored on the associated DB instances)

   .. code-block:: text

      DELETE https://ddm.eu-de.otc.t-systems.com/v1/619d3e78f61b4be68bc5aa0b59edcf7b/instances/1f5c9fd6cd984056ba89c8c87cc03278in09?delete_rds_data=false
