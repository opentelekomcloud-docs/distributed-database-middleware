...
Querying DDM Engine Information (a V2 API)
==========================================
...
-  Use the latest API. For details, see :ref:`Querying DDM Engine Information (a V3 API) <ddm_api_01_0109>`.
...
.. code-block:: text
   ...
   GET https://ddm.eu-de.otc.t-systems.com/v2/619d3e78f61b4be68bc5aa0b59edcf7b/engines?offset=0&limit=10
