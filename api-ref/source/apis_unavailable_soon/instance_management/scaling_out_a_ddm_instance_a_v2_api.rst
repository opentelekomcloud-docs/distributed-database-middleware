...
Scaling Out a DDM Instance (a V2 API)
=====================================
...
-  Use the API of the latest version in :ref:`Scaling Out a DDM Instance (a V3 API) <ddm_api_01_0111>`.
...
-  Example request
   ...
   .. code-block:: text
      ...
      POST https://ddm.eu-de.otc.t-systems.com/v2/619d3e78f61b4be68bc5aa0b59edcf7b/instances/1f5c9fd6cd984056ba89c8c87cc03278in09/action/enlarge
