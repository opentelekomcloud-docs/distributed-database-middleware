...
-  Use the latest API. For details, see :ref:`Querying Details About a Schema (a V3 API) <en-us_topic_0000002217069697>`.
...
.. table:: **Table 4** GetDatabaseResponseBean
   ...
   +-----------------------+-------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
   | updated               | Long                                                                                      | Time when the schema was last updated. The value is a UNIX timestamp, in milliseconds.                  |
   +-----------------------+-------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
