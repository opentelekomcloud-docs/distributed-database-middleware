...
-  Use the latest API. For details, see :ref:`Deleting a Schema (a V3 API) <ddm_api_01_0116>`.
...
-  Request to delete a schema (including the data stored on associated DB instances)
   ...
   .. code-block:: text
      ...
      DELETE https://ddm.eu-de.otc.t-systems.com/v1/619d3e78f61b4be68bc5aa0b59edcf7b/instances/1f5c9fd6cd984056ba89c8c87cc03278in09/databases/ddm_db_test?delete_rds_data=true

-  Request to delete a schema (excluding the data stored on associated DB instances)

   .. code-block:: text

      DELETE https://ddm.eu-de.otc.t-systems.com/v1/619d3e78f61b4be68bc5aa0b59edcf7b/instances/1f5c9fd6cd984056ba89c8c87cc03278in09/databases/ddm_db_test?delete_rds_data=false
