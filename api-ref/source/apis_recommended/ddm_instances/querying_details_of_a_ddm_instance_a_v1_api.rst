...
Querying Details of a DDM Instance (a V1 API)
=============================================
...
.. table:: **Table 4** GetDetailfNodesInfo
   ...
   +-----------+--------+-----------------------------------------------------------------------------------------------+
   | ip        | String | ELB IP address of the group that the node belongs to.                                         |
   +-----------+--------+-----------------------------------------------------------------------------------------------+
...
.. code-block:: text
   ...
   GET https://ddm.eu-de.otc.t-systems.com/v1/619d3e78f61b4be68bc5aa0b59edcf7b/instances/1f5c9fd6cd984056ba89c8c87cc03278in09
...
.. code-block::

   {
     "nodes" : [ {
       ...
       "port" : "5066",
       "ip" : "192.168.0.160",
       "group_id": "b4153b807b1a4f83870bf868fcc4f4eagr09",
